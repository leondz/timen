// $ANTLR 3.4 TIMENruleGrammar.g 2013-05-18 17:16:50
...
public class TIMENruleGrammarParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "COMMENT", "GRANULARITY", "INT", "REFERENCE", "SEPARATOR", "STRING", "WHITESPACE", "'('", "')'", "','", "'ADD'", "'ADD_WEEKDAY'", "'DATE_LAST_WEEKDAY_MONTH'", "'DATE_MONTH'", "'DATE_MONTH_DAY'", "'DATE_WEEKDAY'", "'DATE_WEEKNUM_WEEKDAY_MONTH'", "'DCTDAY'", "'DCTMONTH'", "'DCTYEAR'", "'FILL_ZEROS'", "'GET_TOD'", "'INT('", "'NEGATIVEINT('", "'PAT'", "'TO_DAY'", "'TO_DECADE'", "'TO_ISO'", "'TO_MONTH'", "'TO_PERIOD'", "'TO_TIME'", "'TO_YEAR'"
    };
        ...
        try {
            ...
            do {
                ...
                if ( (LA2_0==SEPARATOR) ) {
                    ...
                    if ( (LA2_1==STRING||(LA2_1 >= 14 && LA2_1 <= 25)||(LA2_1 >= 28 && LA2_1 <= 35)) ) {
                        alt2=1;
                    }
        ...
        try {
            ...
            switch (alt4) {
                case 1 :
                    ...
                    {
                    match(input,33,FOLLOW_33_in_to_period283); 
                ...
                case 2 :
                    ...
                    {
                    match(input,33,FOLLOW_33_in_to_period313); 
                ...
                case 3 :
                    ...
                    {
                    match(input,33,FOLLOW_33_in_to_period340); 
    ...
    public final String to_year(TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,35,FOLLOW_35_in_to_year451); 
    ...
    public final String to_month(TIMEN timen, TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,32,FOLLOW_32_in_to_month475); 
    ...
    public final String to_day(TIMEN timen, TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,29,FOLLOW_29_in_to_day499); 
    ...
    public final String to_iso(TIMEN timen, TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,31,FOLLOW_31_in_to_iso523); 
    ...
    public final String to_decade(TIMEN timen, TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,30,FOLLOW_30_in_to_decade547); 
    ...
    public final String to_time(TIMEN timen, TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,34,FOLLOW_34_in_to_time571); 
    ...
    public final String add(TIMEN timen, TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            // TIMENruleGrammar.g:83:69: ( 'ADD' '(' r= REFERENCE ',' GRANULARITY ',' i= intnumber ')' | 'ADD' '(' r= REFERENCE ',' e= pat[$timex_object] ',' i= intnumber ')' | 'ADD' '(' r= REFERENCE ',' e= pat[$timex_object] ',' i= toint[$timex_object] ')' | 'ADD' '(' r= REFERENCE ',' e= pat[$timex_object] ',' i= tonegativeint[$timex_object] ')' | 'ADD_WEEKDAY' '(' r= REFERENCE ',' e= pat[$timex_object] ',' i= intnumber ')' )
            int alt5=5;
            ...
            switch (alt5) {
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    // TIMENruleGrammar.g:88:11: 'ADD_WEEKDAY' '(' r= REFERENCE ',' e= pat[$timex_object] ',' i= intnumber ')'
                    {
                    match(input,15,FOLLOW_15_in_add807); 
                    ...
                    pushFollow(FOLLOW_pat_in_add825);
                    e=pat(timex_object);
                    ...
                    pushFollow(FOLLOW_intnumber_in_add832);
                    i=intnumber();

                    state._fsp--;


                    match(input,12,FOLLOW_12_in_add834); 
    ...
    // TIMENruleGrammar.g:94:1: date_weekday[TIMEN timen, TIMEX_Instance timex_object] returns [String value] : 'DATE_WEEKDAY' '(' r= REFERENCE ',' e= pat[$timex_object] ')' ;
    public final String date_weekday(TIMEN timen, TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            // TIMENruleGrammar.g:94:78: ( 'DATE_WEEKDAY' '(' r= REFERENCE ',' e= pat[$timex_object] ')' )
            // TIMENruleGrammar.g:95:10: 'DATE_WEEKDAY' '(' r= REFERENCE ',' e= pat[$timex_object] ')'
            {
            match(input,19,FOLLOW_19_in_date_weekday869); 

            match(input,11,FOLLOW_11_in_date_weekday871); 

            r=(Token)match(input,REFERENCE,FOLLOW_REFERENCE_in_date_weekday875); 

            match(input,13,FOLLOW_13_in_date_weekday883); 

            pushFollow(FOLLOW_pat_in_date_weekday887);
            e=pat(timex_object);

            state._fsp--;


            match(input,12,FOLLOW_12_in_date_weekday890); 
    ...
    // TIMENruleGrammar.g:98:1: date_month[TIMEN timen, TIMEX_Instance timex_object] returns [String value] : 'DATE_MONTH' '(' r= REFERENCE ',' e= pat[$timex_object] ')' ;
    public final String date_month(TIMEN timen, TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            // TIMENruleGrammar.g:98:76: ( 'DATE_MONTH' '(' r= REFERENCE ',' e= pat[$timex_object] ')' )
            // TIMENruleGrammar.g:99:10: 'DATE_MONTH' '(' r= REFERENCE ',' e= pat[$timex_object] ')'
            {
            match(input,17,FOLLOW_17_in_date_month914); 

            match(input,11,FOLLOW_11_in_date_month916); 

            r=(Token)match(input,REFERENCE,FOLLOW_REFERENCE_in_date_month920); 

            match(input,13,FOLLOW_13_in_date_month928); 

            pushFollow(FOLLOW_pat_in_date_month932);
            e=pat(timex_object);

            state._fsp--;


            match(input,12,FOLLOW_12_in_date_month935); 
    ...
    // TIMENruleGrammar.g:101:1: date_month_day[TIMEN timen, TIMEX_Instance timex_object] returns [String value] : 'DATE_MONTH_DAY' '(' r= REFERENCE ',' e= pat[$timex_object] ',' d= pat[$timex_object] ')' ;
    public final String date_month_day(TIMEN timen, TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            // TIMENruleGrammar.g:101:80: ( 'DATE_MONTH_DAY' '(' r= REFERENCE ',' e= pat[$timex_object] ',' d= pat[$timex_object] ')' )
            // TIMENruleGrammar.g:102:10: 'DATE_MONTH_DAY' '(' r= REFERENCE ',' e= pat[$timex_object] ',' d= pat[$timex_object] ')'
            {
            match(input,18,FOLLOW_18_in_date_month_day958); 

            match(input,11,FOLLOW_11_in_date_month_day960); 

            r=(Token)match(input,REFERENCE,FOLLOW_REFERENCE_in_date_month_day964); 

            match(input,13,FOLLOW_13_in_date_month_day972); 

            pushFollow(FOLLOW_pat_in_date_month_day976);
            e=pat(timex_object);

            state._fsp--;


            match(input,13,FOLLOW_13_in_date_month_day979); 

            pushFollow(FOLLOW_pat_in_date_month_day983);
            d=pat(timex_object);

            state._fsp--;


            match(input,12,FOLLOW_12_in_date_month_day986); 
    ...
    // TIMENruleGrammar.g:104:1: date_weeknum_weekday_month[TIMEN timen, TIMEX_Instance timex_object] returns [String value] : 'DATE_WEEKNUM_WEEKDAY_MONTH' '(' r= REFERENCE ',' e= pat[$timex_object] ',' d= pat[$timex_object] ',' f= pat[$timex_object] ')' ;
    public final String date_weeknum_weekday_month(TIMEN timen, TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            // TIMENruleGrammar.g:104:92: ( 'DATE_WEEKNUM_WEEKDAY_MONTH' '(' r= REFERENCE ',' e= pat[$timex_object] ',' d= pat[$timex_object] ',' f= pat[$timex_object] ')' )
            // TIMENruleGrammar.g:105:10: 'DATE_WEEKNUM_WEEKDAY_MONTH' '(' r= REFERENCE ',' e= pat[$timex_object] ',' d= pat[$timex_object] ',' f= pat[$timex_object] ')'
            {
            match(input,20,FOLLOW_20_in_date_weeknum_weekday_month1009); 

            match(input,11,FOLLOW_11_in_date_weeknum_weekday_month1011); 

            r=(Token)match(input,REFERENCE,FOLLOW_REFERENCE_in_date_weeknum_weekday_month1015); 

            match(input,13,FOLLOW_13_in_date_weeknum_weekday_month1023); 

            pushFollow(FOLLOW_pat_in_date_weeknum_weekday_month1027);
            e=pat(timex_object);

            state._fsp--;


            match(input,13,FOLLOW_13_in_date_weeknum_weekday_month1030); 

            pushFollow(FOLLOW_pat_in_date_weeknum_weekday_month1034);
            d=pat(timex_object);

            state._fsp--;


            match(input,13,FOLLOW_13_in_date_weeknum_weekday_month1037); 

            pushFollow(FOLLOW_pat_in_date_weeknum_weekday_month1041);
            f=pat(timex_object);

            state._fsp--;


            match(input,12,FOLLOW_12_in_date_weeknum_weekday_month1044); 
    ...
    // TIMENruleGrammar.g:107:1: date_last_weekday_month[TIMEN timen, TIMEX_Instance timex_object] returns [String value] : 'DATE_LAST_WEEKDAY_MONTH' '(' r= REFERENCE ',' e= pat[$timex_object] ',' d= pat[$timex_object] ')' ;
    public final String date_last_weekday_month(TIMEN timen, TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            // TIMENruleGrammar.g:107:89: ( 'DATE_LAST_WEEKDAY_MONTH' '(' r= REFERENCE ',' e= pat[$timex_object] ',' d= pat[$timex_object] ')' )
            // TIMENruleGrammar.g:108:10: 'DATE_LAST_WEEKDAY_MONTH' '(' r= REFERENCE ',' e= pat[$timex_object] ',' d= pat[$timex_object] ')'
            {
            match(input,16,FOLLOW_16_in_date_last_weekday_month1067); 

            match(input,11,FOLLOW_11_in_date_last_weekday_month1069); 

            r=(Token)match(input,REFERENCE,FOLLOW_REFERENCE_in_date_last_weekday_month1073); 

            match(input,13,FOLLOW_13_in_date_last_weekday_month1081); 

            pushFollow(FOLLOW_pat_in_date_last_weekday_month1085);
            e=pat(timex_object);

            state._fsp--;


            match(input,13,FOLLOW_13_in_date_last_weekday_month1088); 

            pushFollow(FOLLOW_pat_in_date_last_weekday_month1092);
            d=pat(timex_object);

            state._fsp--;


            match(input,12,FOLLOW_12_in_date_last_weekday_month1096); 
    ...
    // $ANTLR start "pat"
    // TIMENruleGrammar.g:111:1: pat[TIMEX_Instance timex_object] returns [String value] : 'PAT' '(' e= intnumber ')' ;
    public final String pat(TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            // TIMENruleGrammar.g:111:56: ( 'PAT' '(' e= intnumber ')' )
            // TIMENruleGrammar.g:112:2: 'PAT' '(' e= intnumber ')'
            {
            match(input,28,FOLLOW_28_in_pat1112); 

            match(input,11,FOLLOW_11_in_pat1114); 

            pushFollow(FOLLOW_intnumber_in_pat1118);
            e=intnumber();

            state._fsp--;


            match(input,12,FOLLOW_12_in_pat1120); 
    ...
    // TIMENruleGrammar.g:114:1: tonegativeint[TIMEX_Instance timex_object] returns [int value] : 'NEGATIVEINT(' e= pat[$timex_object] ')' ;
    public final int tonegativeint(TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            // TIMENruleGrammar.g:114:63: ( 'NEGATIVEINT(' e= pat[$timex_object] ')' )
            // TIMENruleGrammar.g:115:5: 'NEGATIVEINT(' e= pat[$timex_object] ')'
            {
            match(input,27,FOLLOW_27_in_tonegativeint1138); 

            pushFollow(FOLLOW_pat_in_tonegativeint1142);
            e=pat(timex_object);

            state._fsp--;


            match(input,12,FOLLOW_12_in_tonegativeint1145); 
    ...
    // $ANTLR start "toint"
    // TIMENruleGrammar.g:117:1: toint[TIMEX_Instance timex_object] returns [int value] : 'INT(' e= pat[$timex_object] ')' ;
    public final int toint(TIMEX_Instance timex_object) throws RecognitionException {
        ...
        try {
            // TIMENruleGrammar.g:117:55: ( 'INT(' e= pat[$timex_object] ')' )
            // TIMENruleGrammar.g:118:5: 'INT(' e= pat[$timex_object] ')'
            {
            match(input,26,FOLLOW_26_in_toint1163); 

            pushFollow(FOLLOW_pat_in_toint1167);
            e=pat(timex_object);

            state._fsp--;


            match(input,12,FOLLOW_12_in_toint1170); 
    ...
    // $ANTLR start "print"
    // TIMENruleGrammar.g:121:1: print returns [String value] : STRING ;
    public final String print() throws RecognitionException {
        ...
        try {
            // TIMENruleGrammar.g:121:29: ( STRING )
            // TIMENruleGrammar.g:122:5: STRING
            {
            STRING5=(Token)match(input,STRING,FOLLOW_STRING_in_print1188); 
    ...
    // TIMENruleGrammar.g:125:1: intnumber returns [int value] : INT ;
    public final int intnumber() throws RecognitionException {
        ...
        try {
            // TIMENruleGrammar.g:125:30: ( INT )
            // TIMENruleGrammar.g:126:2: INT
            {
            INT6=(Token)match(input,INT,FOLLOW_INT_in_intnumber1208); 
    ...
    public static final BitSet FOLLOW_SEPARATOR_in_rules65 = new BitSet(new long[]{0x0000000FF3FFC200L});
    ...
    public static final BitSet FOLLOW_33_in_to_period283 = new BitSet(new long[]{0x0000000000000800L});
    ...
    public static final BitSet FOLLOW_33_in_to_period313 = new BitSet(new long[]{0x0000000000000800L});
    ...
    public static final BitSet FOLLOW_33_in_to_period340 = new BitSet(new long[]{0x0000000000000800L});
    ...
    public static final BitSet FOLLOW_35_in_to_year451 = new BitSet(new long[]{0x0000000000000800L});
    ...
    public static final BitSet FOLLOW_32_in_to_month475 = new BitSet(new long[]{0x0000000000000800L});
    ...
    public static final BitSet FOLLOW_29_in_to_day499 = new BitSet(new long[]{0x0000000000000800L});
    ...
    public static final BitSet FOLLOW_31_in_to_iso523 = new BitSet(new long[]{0x0000000000000800L});
    ...
    public static final BitSet FOLLOW_30_in_to_decade547 = new BitSet(new long[]{0x0000000000000800L});
    ...
    public static final BitSet FOLLOW_34_in_to_time571 = new BitSet(new long[]{0x0000000000000800L});
    ...
    public static final BitSet FOLLOW_15_in_add807 = new BitSet(new long[]{0x0000000000000800L});
    ...
    public static final BitSet FOLLOW_13_in_add821 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_pat_in_add825 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_13_in_add828 = new BitSet(new long[]{0x0000000000000040L});
    public static final BitSet FOLLOW_intnumber_in_add832 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_add834 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_19_in_date_weekday869 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_11_in_date_weekday871 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_REFERENCE_in_date_weekday875 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_13_in_date_weekday883 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_pat_in_date_weekday887 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_date_weekday890 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_17_in_date_month914 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_11_in_date_month916 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_REFERENCE_in_date_month920 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_13_in_date_month928 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_pat_in_date_month932 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_date_month935 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_18_in_date_month_day958 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_11_in_date_month_day960 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_REFERENCE_in_date_month_day964 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_13_in_date_month_day972 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_pat_in_date_month_day976 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_13_in_date_month_day979 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_pat_in_date_month_day983 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_date_month_day986 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_20_in_date_weeknum_weekday_month1009 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_11_in_date_weeknum_weekday_month1011 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_REFERENCE_in_date_weeknum_weekday_month1015 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_13_in_date_weeknum_weekday_month1023 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_pat_in_date_weeknum_weekday_month1027 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_13_in_date_weeknum_weekday_month1030 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_pat_in_date_weeknum_weekday_month1034 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_13_in_date_weeknum_weekday_month1037 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_pat_in_date_weeknum_weekday_month1041 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_date_weeknum_weekday_month1044 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_16_in_date_last_weekday_month1067 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_11_in_date_last_weekday_month1069 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_REFERENCE_in_date_last_weekday_month1073 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_13_in_date_last_weekday_month1081 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_pat_in_date_last_weekday_month1085 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_13_in_date_last_weekday_month1088 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_pat_in_date_last_weekday_month1092 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_date_last_weekday_month1096 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_28_in_pat1112 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_11_in_pat1114 = new BitSet(new long[]{0x0000000000000040L});
    public static final BitSet FOLLOW_intnumber_in_pat1118 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_pat1120 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_27_in_tonegativeint1138 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_pat_in_tonegativeint1142 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_tonegativeint1145 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_26_in_toint1163 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_pat_in_toint1167 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_toint1170 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_in_print1188 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_INT_in_intnumber1208 = new BitSet(new long[]{0x0000000000000002L});
