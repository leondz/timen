...
public class PhraselistFile extends NLPFile {
    ...
    /**
     * Creates a new phraselist from a file.
     * By default: not case-sensitive, en-US locale, canonical forms are not required, and regex are not allowed 
     * 
     * @param filename 
     */
    ...
    public PhraselistFile(String filename) {
     ...
     /**
     * Creates a new phraselist from a file, indicating if it has to be case sensitive, and the locale
     * By default: canonical forms are not required, and regex are not allowed 
     * 
     * @param filename
     * @param casesensitive
     * @param locale
    ...
    /**
     * Creates a new phraselist from a file, indicating if it has to be case sensitive, the locale, if canonical forms are required and if regexes are allowed
     * @param filename
     * @param casesensitive
     * @param locale
